...
public static class Tests {
		...
		void testAdd() {
			...
			heap.add("9", 10);
			assertEquals((Integer)10,heap.priorityMap.get(0));
		...
		void testChangePriority() {
			...
			assertEquals((Integer)3,heap.priorityMap.get(1));
			assertEquals((Integer)8,heap.priorityMap.get(2));
			assertEquals((Integer)(-4), heap.priorityMap.get(4));
			assertEquals((Integer)(-9), heap.priorityMap.get(5));
		...
		void testSwap() {
			...
			heap.swap(9, 2);
			heap.swap(8, 1);
			assertEquals((Integer)0,heap.locationMap.get("2"));
			assertEquals((Integer)2,heap.locationMap.get("10"));
			assertEquals((Integer)8,heap.locationMap.get("1"));
			assertEquals((Integer)(-2),heap.priorityMap.get(9));
			assertEquals((Integer)(-9),heap.priorityMap.get(2));
			assertEquals((Integer)(-4), heap.priorityMap.get(4));
			assertEquals((Integer)(-8), heap.priorityMap.get(1));
			assertEquals((Integer)0, heap.priorityMap.get(8));	
			assertEquals((Integer)(-1),heap.priorityMap.get(0));
		}
